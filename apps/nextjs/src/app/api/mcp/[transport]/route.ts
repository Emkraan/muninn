...
const SERVER_INSTRUCTIONS = `You are connected to Muninn, a self-hosted homelab dashboard.
...
- Docker and Kubernetes tools work only if the Muninn instance has access to the Docker socket or Kubernetes cluster.`;
