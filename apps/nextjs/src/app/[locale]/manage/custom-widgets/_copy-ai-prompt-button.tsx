...
const PROMPT_HEADER = `You are helping configure a Muninn custom widget. Muninn is a self-hosted dashboard that can display data from any API endpoint as a widget.

## Your Task
Generate a valid JSON configuration for a Muninn custom widget based on the user's description and the API response below. If you need clarification, ask specific questions.
