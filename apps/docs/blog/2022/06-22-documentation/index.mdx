...
We are happy to announce that the documentation of Muninn has been migrated to Docusaurus - An opensource documentation tool.
...
The documentation will soon be merged into the master branch of Muninn.
You'll find a ``doc/`` directory in the root of Muninn.
