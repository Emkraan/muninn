---
title: "We present: Muninn 0.12 - The fastest Muninn version ever!"
authors:
  - ajnart
  - manuel-rw
  - walkx
  - meierschlumpf
tags: [muninn, update, breaking changes, version, dnd, documentation]
---
...
- Integrate your services (for example Sonarr, Radarr and Overseerr) directly into Muninn
...
## 😎 Blazingly fast
We've implemented a new caching system, that will cache all data in your browser, meaning that Muninn will load within milliseconds, as if it was *powered by rust and blazingly fast* !!!
...
Muninn will load now within milliseconds and cache data in your browser.
