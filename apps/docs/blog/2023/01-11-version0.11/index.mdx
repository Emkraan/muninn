---
title: "We present: Muninn 0.11 - the most complex Muninn version yet!"
authors:
  - ajnart
  - manuel-rw
  - walkx
  - meierschlumpf
tags: [muninn, update, breaking changes, version, gridstack, dnd, documentation]
---

We are *incredibly* proud to serve you Muninn 0.11!
...
- Huge design and usability improvements to older components to Muninn
...
## Design and documentation improvements to the documentation site

The [documentation site](https://github.com/Emkraan/muninn) has been overhauled with better design, updated documentation, more images and better explanations.

## Download Muninn now!

Muninn is completly free, even for commercial usage!
