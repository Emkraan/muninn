...
In this guide, we will show you how to migrate from Muninn 0.15.10+ to 1.0.0.
...
As 1.0 is a complete rewrite of Muninn and therefor not compatible with the old docker mounts, we need to export your data first.
...
We highly recommend to create a parallel installation of Muninn 1.0.0.
So if something with for example the import does not quite work, the data in the old installation is still available.
To do this you can follow the appropriate [installation guide](https://muninn.dev/docs/category/installation-1) for your system.
...
## Import your data
Once the installation is completed you can access the new installation. During the onboarding you'll need to select `Import from Muninn before 1.0`.
...
See [After the installation](https://muninn.dev/docs/getting-started/after-the-installation) for more information.
