...
## Icon picker
Icons in Muninn are automatically requested from multiple sources:
...
Using these icon sources, Muninn provides a total collection of over 11,000 icons at your fingertips.
...
If you can't find the icon you're looking for in Muninn's built-in picker, we strongly recommend checking [Dashboard Icons](https://dashboardicons.com/). It offers a modern, user-friendly interface and a curated collection of high-quality icons specifically designed for dashboards and app directories.
