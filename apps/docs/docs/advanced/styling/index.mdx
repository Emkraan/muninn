...
Muninn uses https://mantine.dev/ under the hood. You can change the look & feel of Muninn
...
## Using Muninn's classes
Muninn's elements will already have a lot of classes and styles pre-applied.
...
CSS classes that will change with every build. This means, every time you update Muninn,
