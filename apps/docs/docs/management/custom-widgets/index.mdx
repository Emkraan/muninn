...
Custom widgets are a new feature. Share feedback, ask questions, and discuss ideas in our [GitHub Discussions](https://github.com/Emkraan/muninn/discussions/categories/custom-widgets).

:::

Custom widgets allow you to fetch data from any HTTP API and display it on your Muninn dashboard. You define the API endpoint, authentication, and how the response should be rendered - no code compilation or server restart required.
