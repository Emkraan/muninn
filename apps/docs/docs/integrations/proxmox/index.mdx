...
<IntegrationSecrets secrets={[{
    ...
    steps: [
        ...
        <>
            ...
            <ul>
                ...
                <li>Token ID: something informative like the application or purpose like muninn</li>
    ...
    body: <>
        <span>
            Sometimes you'll also find the <code>api@pve!muninn</code> format, 
            within Muninn you'll have to split it up into:
        </span>
        <ul>
            <li>
                <b>Username:</b> api
