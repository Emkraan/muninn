...
The iCal integration allows you to add external calendars to Muninn. Any calendar that provides a public iCal URL can be integrated, such as Google Calendar, Apple Calendar, or Outlook.