...
This is recommended when you used Muninn before and want to re-import your data.
...
<img
  ...
  alt="Export from old Muninn"
  style={{ maxWidth: 500 }}
/>

**How to export and import data**

1. Navigate to your old Muninn, open your management pages, open the tools submenu and open `Migrate to 1.0`.
...
5. Go to your new >1.0.0 Muninn instance and start the onboarding. Choose `Import from Muninn before 1.0`
