...
You can install Muninn directly from your Unraid Dashboard, no terminal required.
...
After you've installed the Community Apps Plugin, you can install Muninn from the Unraid Dashboard.

1. Navigate to the tab "Apps".
2. Search for "Muninn" and click on the result.
3. Click on "Install" and adjust the settings to your liking.

![](img/unraid-apps-homarr.webp)

After you've installed Muninn, you can find it under the tab "Docker".

The official support thread is located [here](https://forums.unraid.net/topic/123478-support-smartphonelover-homarr/), but we prefer to communicate over GitHub instead.
