...
To install Muninn using Portainer Stacks, simply create a new stack and paste the following code into it.
...
To update Muninn using Docker Compose or Portainer Stacks, simply pull the latest image and restart the container.

1. Run ``docker pull ghcr.io/emkraan/muninn:latest`` to pull the latest image.
