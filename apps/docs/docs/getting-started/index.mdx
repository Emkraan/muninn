...
Before you try to install Muninn, please review if your device meets the requirements.
...
We build Muninn for a bunch of different architectures, including ARM. Please ensure that your device architecture is supported by Muninn. We won't be able to provide support for unusual or outdated architectures.
