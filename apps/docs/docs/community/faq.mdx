...
### Can I install Muninn on a Raspberry Pi?
Yes, Muninn is compatible with the architecture of the Raspberry Pi. Have a look in our [installation guide](/docs/category/installation-1) on how to do so.

### I have a suggestion / idea for improvement or want to report a bug
You can report issues, suggestions, or ideas for improvements <a href="https://github.com/Emkraan/muninn/issues/new/choose">here</a>.

### Can I use my own custom icons for apps?
Yes, check out our guide on [how to add your custom icons](/docs/advanced/icons).
...
If you still want to add a widget, please consider to contribute it directly to Muninn. For that, basic programming skills are required. Our [Developer Guides](/docs/advanced/development/getting-started) explain this even more detailed.

### Is it secure to expose Muninn to the web?

Yes, since v0.14.0, we are confident that Muninn is secure enough to be exposed to the web. 
...
Open your browser and ensure, that Muninn is your current tab.
...
> Please never execute any commands in the console. Scammers are using the console to let you execute harmful commands. If you want to resolve an issue in Muninn, **you'll never have to execute any commands here**

  </TabItem>
  <TabItem value="orange" label="Read log">

This depends on your installation method. If you use Unraid, you can simply click on the App and on ``Log``. If you have a bare Docker install, use ``docker container logs muninn``. If you used a different name than ``muninn`` for your container, you need to replace said argument. Here is some additional information about the command: https://geekflare.com/check-docker-logs/.
...
### Can I use Muninn at my company?
Yes, you can! But please consider a donation, if our work has been useful to you.

### I think I found a bug. What can I do?
If you think, that you found a bug, please create an issue <a href="https://github.com/Emkraan/muninn/issues/new/choose">here</a>.

### Why can't I use my custom icons?
You need to restart the Muninn Docker container after adding icons.

### Why can't Muninn see/ping containers running locally behind GluetunVPN?
...
Yes, go [here](/docs/community/get-in-touch) to get with us in touch.

<hr/>

:::tip

Haven't found the solution to your problem / question? We are eager to help you in a [GitHub Issue](https://github.com/Emkraan/muninn/issues/new/choose).
