...
Set the current paragraph or heading to left-to-right or right-to-left. This is useful when writing right-to-left text while Muninn is using a left-to-right language, or vice versa.
