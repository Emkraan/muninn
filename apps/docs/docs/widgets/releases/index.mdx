...
For GitHub Container Registry, use `owner/package` identifiers such as `Emkraan/muninn`.
Full image references such as `ghcr.io/emkraan/muninn:latest` are also accepted.
