...
export default function Home() {
  return (
    <Layout description="Simplify the management of your server with Muninn - a sleek, modern dashboard that puts all of your apps and services at your fingertips. With Muninn, you can access and control everything in one convenient location. Muninn seamlessly integrates with the apps you've added, providing you with valuable information and giving you complete control. Installation is a breeze, and Muninn supports a wide range of deployment methods.">
      <HomeHero />
