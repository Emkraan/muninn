...
export type MuninnDocumentationPath =
  | "/about-us"
  | "/api-reference"
  | "/search"
  | "/docs/tags"
  | "/docs/tags/access-control"
  ...
  | "/docs/management/access-control"
  | "/docs/management/api"
  | "/docs/management/api/board-as-code"
